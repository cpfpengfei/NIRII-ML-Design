"""
The following graphConvModel is based on DeepChem: https://github.com/deepchem/deepchem
with modification to include the tunability of multiple dense layers.

The modified graphConvModel was created and first demonstrated in: A Self-Improving Photosensitizer Discovery System via Bayesian Optimization and Quantum Chemical Calculation 
(preprint: https://chemrxiv.org/articles/preprint/A_Self-Improving_Photosensitizer_Discovery_System_via_Bayesian_Optimization_and_Quantum_Chemical_Calculation/14757975)
